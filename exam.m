...
% Last Modified by GUIDE v2.5 30-Apr-2024 12:04:43
...
% so window can get raised using exam.
...
popup_sel_index = get(handles.menu, 'Value');
...
set(hObject, 'String', {'Sinus', 'cosinus', 'tangente', 'logarithme', 'exponentiel'});
